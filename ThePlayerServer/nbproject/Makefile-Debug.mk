...
${OBJECTDIR}/TCPServerSocket.o: TCPServerSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TCPServerSocket.o TCPServerSocket.cpp

${OBJECTDIR}/StreamServerThread.o: StreamServerThread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/StreamServerThread.o StreamServerThread.cpp
