...
**
** Created: Wed Jul 11 11:31:52 2012
...
static const char qt_meta_stringdata_CoverDownloader[] = {
    "CoverDownloader\0\0image\0renderedImage(QImage)\0"
};
...
const QMetaObjectExtraData CoverDownloader::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CoverDownloader::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CoverDownloader,
      qt_meta_data_CoverDownloader, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CoverDownloader::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CoverDownloader))
...
// SIGNAL 0
void CoverDownloader::renderedImage(const QImage & _t1)
{
